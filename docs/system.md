...
void $draw_text_P(i16, i16, sprites, char[] prog&);
void $draw_textf(i16, i16, sprites, char[] prog&, ...);
...
u16 $strlen(char[]&);
sprites $strlen_P(char[] prog&);
u16 $text_width(sprites, char[]&);
u16 $text_width_P(sprites, char[] prog&);
```
