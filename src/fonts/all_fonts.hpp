...
static font_info_t const ALL_FONTS[] = {
    ...
    { "FONT_BLOCKKIE", 23, FONT_BLOCKKIE, sizeof(FONT_BLOCKKIE) },
    ...
    { "FONT_NOKIAFC", 8, FONT_NOKIAFC, sizeof(FONT_NOKIAFC) },
    ...
    { "FONT_PIXELGEORGIA", 11, FONT_PIXELGEORGIA, sizeof(FONT_PIXELGEORGIA) },
    { "FONT_PIXELGEORGIABOLD", 11, FONT_PIXELGEORGIABOLD, sizeof(FONT_PIXELGEORGIABOLD) },
    ...
    { "FONT_PIXELTIMES", 11, FONT_PIXELTIMES, sizeof(FONT_PIXELTIMES) },
    { "FONT_PIXELTIMESBOLD", 11, FONT_PIXELTIMESBOLD, sizeof(FONT_PIXELTIMESBOLD) },
    { "FONT_PIXOLLETTA", 8, FONT_PIXOLLETTA, sizeof(FONT_PIXOLLETTA) },
    { "FONT_RAINYHEARTS", 12, FONT_RAINYHEARTS, sizeof(FONT_RAINYHEARTS) },
    { "FONT_RETRON2000", 21, FONT_RETRON2000, sizeof(FONT_RETRON2000) },
    { "FONT_SIMPLIPIXA", 4, FONT_SIMPLIPIXA, sizeof(FONT_SIMPLIPIXA) },
    { "FONT_TUBEOFCORN", 12, FONT_TUBEOFCORN, sizeof(FONT_TUBEOFCORN) },
