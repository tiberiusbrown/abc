...
{
    { "draw_sprite_array",
        { "draw_sprite_array_P", "draw_sprite_array16", "draw_sprite_array16_P" }},
...
std::unordered_map<std::string, sysfunc_t> const sys_names =
{
    ...
    { "draw_sprite_array",     SYS_DRAW_SPRITE_ARRAY     },
    { "draw_sprite_array_P",   SYS_DRAW_SPRITE_ARRAY_P   },
    { "draw_sprite_array16",   SYS_DRAW_SPRITE_ARRAY16   },
    { "draw_sprite_array16_P", SYS_DRAW_SPRITE_ARRAY16_P },
